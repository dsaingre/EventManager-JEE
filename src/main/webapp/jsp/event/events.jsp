...
<body>
	...
	<div class="container">
		...
		<a href="<app:uri src="/addevent" />" class="waves-effect waves-light btn"><i class="material-icons left">add</i>Créer un événement</a>


		<c:forEach var="event" items="${events}">
			<p>${event.name} - ${event.location}</p>
			<a href="<app:uri src="/events/" />${event.getId()}">Voir les informations de
				l'événement</a>
		</c:forEach>
	</div>
